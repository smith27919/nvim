...
-- To force a check, delete ~/.local/state/nvim/deps-checked.
...
-- Something is missing: show the script in a split so it can ask.
local function open_installer(commit)
